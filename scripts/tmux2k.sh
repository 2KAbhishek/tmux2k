...
set_theme() {
    case $theme in
    "catppuccin")
        bg_main=$(get_tmux_option "@tmux2k-bg-main" '#1e1e2e')
        bg_alt=$(get_tmux_option "@tmux2k-bg-alt" '#313244')
        black=$(get_tmux_option "@tmux2k-black" '#11111b')
        ...
        light_green=$(get_tmux_option "@tmux2k-light-green" '#a6e3a1')
        blue=$(get_tmux_option "@tmux2k-blue" '#89b4fa')
        light_blue=$(get_tmux_option "@tmux2k-light-blue" '#89dceb')
        yellow=$(get_tmux_option "@tmux2k-yellow" '#fab387')
